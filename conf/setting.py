...
BASE_PATH = os.path.normpath(os.path.join(__file__,"..",".."))  # 项目路径
DB_PATH = os.path.join(BASE_PATH,'db')           # 用户信息文件存放路径
LOG_PATH = os.path.join(BASE_PATH,'log')         # 日志文件存放路径
ROOT_PATH = os.path.join(BASE_PATH,'db','root')  # 管理员账户文件路径
...
login_log_file = os.path.join(LOG_PATH,'login.log')              # 用户操作相关日志文件
transaction_log_file = os.path.join(LOG_PATH,'transaction.log')  # 金钱交易相关日志文件
default_log_file = os.path.join(LOG_PATH,'default.log')          # 弄人日志文件
...
#    🔰控制日志输出的位置
    'handlers': {
        'login_handler': {                   # 自定义"handlers"名字,可以改
            ...
            'filename': login_log_file,       # 制定日志文件路径
